    ...
    const ProjectDesc = () => {
        return (
            <div className="desc_container">
                <div className="desc_container-heading">Buy Carbon Credits as NFTs</div>
                <div className="desc_container-description">Offset your carbon footprint today by acquiring unique carbon credit NFTs. Each NFT represents a carbon offset project, championing a sustainable future.</div>
            </div>
        )
    }
